 ...
 *
 * NOTE: this file is duplicated verbatim in plugin/lib/connect.js — the host
 * mints tokens with the plugin copy, the viewer reads them with this copy, so
 * they MUST stay byte-identical (guarded by cli/test/connect.test.mjs).
 */
